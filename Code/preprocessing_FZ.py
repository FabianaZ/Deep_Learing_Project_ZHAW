...
parent_folder = "../500hPaGeopotential"  # [TO BE ADPATED ON YOUR LOCAL MACHINE]

# csv file in the Labeling Folder
labeling_file = 'binaryclassification_fast.csv'  # [CHOOSE A LABELING FILE WITHIN THE LABELING FOLDER]
